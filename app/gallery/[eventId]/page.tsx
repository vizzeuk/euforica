...
export default async function GalleryPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      {/* CTA para crear su propio evento - Colocado estratégicamente antes de la galería completa */}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mb-6 text-neutral-300 lg:text-lg">
            ...
            <div className="rounded-lg border border-white/20 bg-white/10 p-6 backdrop-blur-sm md:p-8">
              <div className="mb-6">
                <h3 className="mb-2 text-sm font-medium uppercase tracking-wider text-white/80">
                  Disponible hasta
                </h3>
              ...
              {gallery.allowDownload && (
                <div className="space-y-3 border-t border-white/20 pt-6 text-sm text-white/90">
                  <p>
                    <span className="font-medium text-white">Tip:</span> Haz clic en cualquier foto para verla en pantalla completa
                  </p>
                  <p>
