...
```css
--background: 0 0% 100% /* Blanco puro #FFFFFF */ --foreground: 0 0% 3%
  /* Negro casi puro #080808 */ --primary: 0 0% 9% /* Negro suave #171717 */
  --primary-foreground: 0 0% 98% /* Blanco off-white #FAFAFA */ --secondary: 0
  0% 96% /* Gris muy claro #F5F5F5 */ --secondary-foreground: 0 0% 9% --muted: 0
  0% 96% /* Gris claro #F5F5F5 */ --muted-foreground: 0 0% 45%
  /* Gris medio #737373 */ --border: 0 0% 90% /* Gris borde #E5E5E5 */ --ring: 0
  0% 3% /* Focus ring negro */;
```

**Modo Oscuro:**

```css
--background: 0 0% 2% /* Negro profundo #050505 */ --foreground: 0 0% 98%
  /* Blanco casi puro */ --primary: 0 0% 98% --secondary: 0 0% 15%
  /* Gris oscuro #262626 */ --muted: 0 0% 15% --muted-foreground: 0 0% 64%
  /* Gris claro #A3A3A3 */ --border: 0 0% 15% --input: 0 0% 15%;
```
